...
const (
	...
	// build (0.9.0 features: reliable live-only notification mirror with
	// per-app filter + progress drop). Single source of truth:
...
var BuildToVersion = map[int]string{1: "0.1.0", 2: "0.2.0", 3: "0.3.0", 4: "0.4.0", 5: "0.5.0", 6: "0.6.0", 7: "0.7.0", 8: "0.8.0", 9: "0.9.0"}
