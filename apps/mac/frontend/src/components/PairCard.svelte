...
<section aria-label="Pair your phone" class="card px-5 py-5">
  ...
  {#if qrSrc}
    <div class="anim-qr mx-auto my-4 w-fit rounded-xl bg-white p-3 ring-1 ring-separator">
      <img src={qrSrc} alt="Pairing QR code" class="h-48 w-48 rounded" />
    </div>
  {:else}
    <div class="mx-auto my-4 w-fit rounded-xl bg-altrow p-3 ring-1 ring-separator" role="status" aria-label="Waiting for pairing code">
