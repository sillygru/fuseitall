...
<section aria-label="Activity" class="section flex min-h-0 flex-1 flex-col overflow-hidden">
  ...
  {#if items.length}
    <ul class="min-h-[120px] flex-1 overflow-y-auto px-1 py-1 text-[12px] leading-relaxed">
